...
Цель работы — изучение структуры HTML-документов и реализация семантической разметки[cite: 1, 5]. В отличие от классических статических страниц, данный проект построен как **SPA (Single Page Application)** на React, что соответствует современным стандартам IT-индустрии и требованиям стажировки в **Modsen**.
